...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/javascript' => ['modules', 'mjs', 'jsm'],
        ...
        'application/x-javascript' => ['modules', 'jsm', 'mjs'],
        ...
        'text/ico' => ['ico'],
        'text/jade' => ['jade'],
        'text/javascript' => ['modules', 'jsm', 'mjs'],
        'text/jsx' => ['jsx'],
        'text/less' => ['less'],
    ...
    private const REVERSE_MAP = [
        ...
        'modules' => ['text/javascript', 'application/javascript', 'application/x-javascript'],
